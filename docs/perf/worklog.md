...
and then onto 639d7d5, where main had merged the clock by pass, the weather
gate, a rewritten digest and a rewritten budget. On 639d7d5 the digest
matches, the tide-flats test reads the third small globe as main now has
it, and the budget was rewritten once more to carry the peak: with the
weather gate the valley churns 14.2 MiB, ancient 80.5 and globe128 501.0.
