...
// is a sliver of the ground one at the equator is. Seed 1's permafrost is 9.0%
// of the land by the area and 24.1% counted by the tile, against some fifteen
...
// carrying a plate's travel short of a whole tile brought it here.
